...
export default function Header_For_Pg_Two() {
    return (
<div className=''>
    <ul className='sm:mt-[20px] md:mt-[px] lg:-mt-[px] xl:-mt-[px] 2xl:mt-[px] 
    sm:ml-[20px] md:ml-[px] lg:ml-[px] xl:ml-[px] 2xl:ml-[px]
    sm:block md:block lg:block block xl:hidden block 2xl:hidden'>
    <Image src={menu} alt="sorry"/></ul>
...
p-4 '>
  ...
  '>
<ul className='  sm:mt-[80px] md:mt-[20px] lg:mt-[10px] xl:mt-[4.8px] 2xl:mt-[6px]
...
sm:w-[150px]
  ...
  sm:-mt-[23px] md:mt-[px] lg:mt-[px] xl:mt-[px] 2xl:mt-[px]
...
<ul className='  sm:-mt-[70px] md:-mt-[px] lg:-mt-[px] xl:-mt-[px] 2xl:-mt-[45px]
